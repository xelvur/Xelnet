...
private:
	...
	// FIX: вместо static переменной внутри цикла — поле класса.
	// static внутри for-цикла = один вектор на все итерации, memory никогда не освобождается.
	std::vector<CTrailPart> m_TrailBuffer;
