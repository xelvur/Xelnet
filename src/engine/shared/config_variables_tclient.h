...
// FIX: диапазон 1-32, default 4:3. Было min=4 max=16 что ломало старые сохранённые конфиги.
// Защита от деления на ноль — в gameclient.cpp проверяем TcStretchHeight > 0
