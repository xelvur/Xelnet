...
MACRO_CONFIG_INT(TcStretchWidth, tc_stretch_width, 4, 1, 32, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Stretch aspect width")
MACRO_CONFIG_INT(TcStretchHeight, tc_stretch_height, 3, 1, 32, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Stretch aspect height")
